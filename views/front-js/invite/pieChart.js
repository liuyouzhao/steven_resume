...
function pieChart(charDataName, canvasName) {
  ...
  function init(charDataNameIn, canvasNameIn) {
    chartDataName = charDataNameIn;
    canvasName = canvasNameIn;
    ...
    $('#'+chartDataName+' td').each( function() {
      currentCell++;
      if ( currentCell % 2 != 0 ) {
        currentRow++;
    ...
    drawChart();
    $('#' + canvasName).click ( handleChartClick );
  }
  ...
  function handleChartClick ( clickEvent ) {
    ...
    var mousePos = getPointOnCanvas(canvas, clickEvent.pageX, clickEvent.pageY);
  ...
  function startPullOut ( slice ) {
    ...
    $('#'+chartDataName+' td').removeClass('highlight');
    var labelCell = $('#'+chartDataName+' td:eq(' + (slice*2) + ')');
    var valueCell = $('#'+chartDataName+' td:eq(' + (slice*2+1) + ')');
